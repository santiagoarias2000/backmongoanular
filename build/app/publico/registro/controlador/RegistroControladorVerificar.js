...
const Usuario_1 = __importDefault(require("../../../compartido/entidad/Usuario"));
...
class RegistroControladorVerificar {
    ...
    static usuarioRegisto(parametros, ciudad, rol) {
        return new Usuario_1.default(parametros.nombresUsuario, parametros.apellidosUsuario, 'DOC_USU' + (0, nanoid_1.nanoid)(20), 1, "No Disponible", "No Disponible", 1, rol, ciudad);
    }
}
exports.default = RegistroControladorVerificar;
